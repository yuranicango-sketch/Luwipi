...
import { getLessonHistory, getLocalStudents, type LessonHistory, type LocalStudent } from "@/lib/teacher-store";
...
export function HomePracticePanel(){
 ...
 }):<div className={styles.empty}><strong>Ainda não há cartões.</strong><span>Conclua uma aula no Modo Aula e o primeiro aparece aqui.</span></div>}</section></div>
}
