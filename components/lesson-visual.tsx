...
export function LessonVisual({stepId,icon,title,age,accent,instruction=""}:Props){
 ...
 return <div className={styles.visual} style={{"--accent":accent} as CSSProperties} aria-label={`Cena da etapa: ${title}`}>
  ...
  {kind==="hands"&&<div className={styles.assetScene}><div className={styles.handWrap}><img src={A.hand} alt="Mão aberta com dedos numerados"/></div><b>1 POLEGAR · 2 INDICADOR · 3 MÉDIO · 4 ANELAR · 5 MÍNIMO</b></div>}
