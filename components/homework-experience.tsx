...
const pianoKeys: PianoKey[] = [
  { note: "Dó", label: "Dó", color: "#ff5f86", sample: "https://tonejs.github.io/audio/salamander/C4.mp3", playbackRate: 1 },
  { note: "Ré", label: "Ré", color: "#ffbf3f", sample: "https://tonejs.github.io/audio/salamander/C4.mp3", playbackRate: Math.pow(2, 2/12) },
  { note: "Mi", label: "Mi", color: "#64c96b", sample: "https://tonejs.github.io/audio/salamander/Ds4.mp3", playbackRate: Math.pow(2, 1/12) },
  { note: "Sol", label: "Sol", color: "#4b9df8", sample: "https://tonejs.github.io/audio/salamander/Fs4.mp3", playbackRate: Math.pow(2, 1/12) },
];
    ...
    <div className="homework-experience">
      <section className="homework-story">
        ...
        <div className="story-world" aria-hidden="true">
          ...
          <div className="character" style={{left:`${Math.min(82, 8 + (step / Math.max(1,sequence.length)) * 74)}%`}}>🐑</div>
