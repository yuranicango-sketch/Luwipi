...
const minuetScore:PianoScoreEvent[]=[
 {right:["Ré4"],left:["Sol3"],beats:1,rightFingering:[1],leftFingering:[5],dynamic:"mp",articulation:"legato"},
 {right:["Sol4"],left:["Ré4"],beats:1,rightFingering:[2],leftFingering:[1],articulation:"legato"},
 {right:["Lá4"],left:["Sol3"],beats:1,rightFingering:[3],leftFingering:[5],articulation:"legato",phraseEnd:true},
 {right:["Si4"],left:["Sol3"],beats:1,rightFingering:[4],leftFingering:[5],articulation:"legato"},
 {right:["Dó5"],left:["Mi3"],beats:1,rightFingering:[5],leftFingering:[5],articulation:"legato"},
 {right:["Ré5"],left:["Ré3"],beats:1,rightFingering:[5],leftFingering:[5],articulation:"accent",phraseEnd:true},
 {right:["Sol4"],left:["Sol3"],beats:1,rightFingering:[2],leftFingering:[5],dynamic:"p",articulation:"legato"},
 {right:["Sol4"],left:["Ré4"],beats:1,rightFingering:[2],leftFingering:[1],articulation:"legato"},
 {right:["Mi4"],left:["Dó3"],beats:1,rightFingering:[1],leftFingering:[5],articulation:"legato",phraseEnd:true},
 {right:["Dó5"],left:["Dó3"],beats:1,rightFingering:[4],leftFingering:[5],dynamic:"mf"},
 {right:["Ré5"],left:["Lá3"],beats:1,rightFingering:[5],leftFingering:[2]},
 {right:["Mi5"],left:["Ré3"],beats:1,rightFingering:[5],leftFingering:[5],phraseEnd:true},
 {right:["Fá5"],left:["Ré3"],beats:1,rightFingering:[5],leftFingering:[5],dynamic:"mp"},
 {right:["Sol5"],left:["Si3"],beats:1,rightFingering:[5],leftFingering:[2]},
 {right:["Lá5"],left:["Dó4"],beats:1,rightFingering:[5],leftFingering:[1],phraseEnd:true},
 {right:["Si5"],left:["Sol3"],beats:1,rightFingering:[5],leftFingering:[5],dynamic:"p"},
 {right:["Dó5"],left:["Ré4"],beats:1,rightFingering:[4],leftFingering:[1]},
 {right:["Si4"],left:["Sol3"],beats:1,rightFingering:[3],leftFingering:[5],phraseEnd:true},
 {right:["Lá4"],left:["Dó4"],beats:1,rightFingering:[2],leftFingering:[1]},
 {right:["Sol4"],left:["Si3"],beats:1,rightFingering:[1],leftFingering:[2]},
 {right:["Fá4"],left:["Lá3"],beats:1,rightFingering:[3],leftFingering:[3],phraseEnd:true},
 {right:["Mi4"],left:["Dó4"],beats:1,rightFingering:[2],leftFingering:[1]},
 {right:["Ré4"],left:["Ré4"],beats:1,rightFingering:[1],leftFingering:[1]},
 {right:["Sol4"],left:["Sol3"],beats:2,rightFingering:[2],leftFingering:[5],dynamic:"mp",phraseEnd:true}
];
...
export const musicDataI:KidsSong[]=[
 ...
 song("minueto-sol-petzold","Minueto em Sol","Christian Petzold · duas mãos e fraseado","🏛️","3/4","Intermédio","Uma primeira peça clássica para sentir três tempos, fraseado e coordenação real entre as duas mãos.",[{label:"Tema inicial",notes:["Ré4","Sol4","Lá4","Si4","Dó5","Ré5"]},{label:"Resposta",notes:["Sol4","Sol4","Mi4","Dó5","Ré5","Mi5"]},{label:"Continuação",notes:["Fá5","Sol5","Lá5","Si5","Dó5","Si4"]},{label:"Cadência",notes:["Lá4","Sol4","Fá4","Mi4","Ré4","Sol4"]}],"Minueto em Sol, BWV Anh. 114, atribuído a Christian Petzold; composição em domínio público. Arranjo pedagógico Luwipi.",3,{grandStaff:true,scoreEvents:minuetScore}),
