...
export const lessonTemplates: LessonTemplate[] = [
  ...
  lesson("23-bear-bird","2-3","iniciante","O Urso e o Passarinho","Brilha, Brilha, Estrelinha",["pitch","listening","keyboard"],"Caminho do urso e voo do passarinho","Urso: passos pesados. Passarinho: braços leves. Troque quando o som muda.","Quem cantou?","Toque dois extremos do piano escondendo as mãos.","Encontra a casa","Leve o urso para o grave e o passarinho para o agudo.","Cante a mesma música em duas regiões e deixe a criança responder com gesto."),
