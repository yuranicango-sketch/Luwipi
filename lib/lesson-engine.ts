...
function firstLesson(age:AgeGroup):LessonStep[]{
  if(age==="2-4") return [
    ...
    {id:"activity",icon:"🎮",title:"Onde mora o som?",duration:"3–4 min",goal:"Repetir a descoberta sem transformar a aula numa explicação.",actions:["Toque um som bem grave.","Peça para apontar para o lado onde acha que o som mora.","Faça o mesmo com um som bem agudo.","Faça 4 tentativas no total."],say:"Onde mora este som? Mostra com o dedo.",childDoes:"Aponta a região e, se quiser, toca uma tecla ali.",success:"Acerta ou se aproxima da região correta em 3 de 4 tentativas.",tip:"Material: imprima as duas casas. Coloque CASA DO SOM GRANDÃO à esquerda do piano e CASA DO SOM PEQUENINO à direita antes de começar.",actionLabel:"BAIXAR AS 2 CASAS · A4",actionHref:"/printables/aula-1/casas-onde-mora-o-som.pdf"},
