...
export const methodVolumePaths: MethodVolumePath[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      { id:"v3-character", order:2, title:"Contraste entre movimentos", subtitle:"Allegro, Andante e Vivace", goal:"Mudar caráter, toque e pulso mantendo controlo técnico.", competencies:["dynamics","rhythm","listening","memory"], scoreIds:["v3-character-study"], repertoireReferences:["Clementi — Allegro / Andante / Vivace"] },
      { id:"v3-broken", order:3, title:"Acompanhamento quebrado contínuo", subtitle:"Regularidade sem endurecer", goal:"Manter padrão uniforme enquanto a melodia respira.", competencies:["coordination","fingers","pulse","hand"], scoreIds:["v3-broken-chord-study"], repertoireReferences:["Sonatina in C Major, Op. 55 No. 1 — Kuhlau"] },
  ...
  },
  {
    ...
    stages: [
      ...
      { id:"v4-movements", order:5, title:"Vários movimentos", subtitle:"Forma, caráter e transições", goal:"Planear uma obra em secções com objetivos técnicos diferentes.", competencies:["memory","coordination","dynamics","reading"], scoreIds:["v4-movement-study"], repertoireReferences:["Sonatina in G Major — Beethoven"] }
    ]
  },
  {
    volume: 5,
