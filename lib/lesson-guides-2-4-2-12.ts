...
export const guides24_2_12: Record<string, ManualLessonGuide> = {
  "2-4:2": {
    teach: ["Toque uma tecla bem grave e diga 'elefante'.", "Toque uma tecla bem aguda e diga 'passarinho'.", "Repita os dois sons em ordem diferente três vezes.", "Depois deixe a criança tocar um som para cada personagem."],
    say: "Se o som é grandão, é o elefante. Se é fininho, é o passarinho.",
    practice: ["Faça 4 comparações grave/agudo.", "Em cada comparação, a criança aponta o personagem antes de tocar.", "No fim, peça um som de elefante e um de passarinho no piano."],
    childDoes: "Escuta, escolhe o personagem e encontra uma região parecida no piano.",
  },
  "2-4:3": {
    teach: ["Coloque um elefante/objeto no lado grave do teclado e um passarinho no lado agudo.", "Toque um som e peça para a criança levar o dedo até a 'casa' certa.", "Depois troque: a criança toca e o professor aponta a casa.", "Faça apenas 4–6 tentativas."],
    say: "Onde mora este som: na casa do elefante ou do passarinho?",
    practice: ["Toque 3 sons em regiões diferentes.", "A criança aponta a casa e depois repete um som parecido.", "Termine fazendo uma sequência grave–agudo–grave."],
    childDoes: "Relaciona o que ouve com uma região do teclado.",
  },
  "2-4:4": {
  ...
  "2-4:5": {
    ...
    say: "Agora os nossos pés vão ensinar as mãos: gigante... formiga.",
    practice: ["Faça uma sequência de 4 gestos: gigante–formiga–formiga–gigante.", "A criança repete primeiro com o corpo e depois numa tecla.", "Repita apenas duas vezes."],
    childDoes: "Transforma um movimento corporal em forte e suave no piano.",
  },
  "2-4:6": {
  ...
  "2-4:8": {
    ...
    say: "Enquanto o tambor anda, nós andamos. Quando ele para, viramos estátua.",
    practice: ["Faça três rodadas curtas de andar/parar.", "Na última, troque passos por uma tecla no piano.", "Pare antes da criança cansar."],
    childDoes: "Segue o pulso e responde ao início e à parada.",
  },
  "2-4:9": {
