...
export const musicDataG: KidsSong[] = [
  ...
  {
    id:"ponte-das-duas-maos",title:"Ponte das Duas Mãos",subtitle:"Peça original · coordenação progressiva",age:"5-8",difficulty:"Intermédio",theme:"coordenação e fraseado",emoji:"🌉",rights:"original",playable:true,category:"repertorio-5-8",sheetMusic:true,timeSignature:"4/4",story:"A mão esquerda constrói a base e a mão direita atravessa a ponte em frases cada vez mais longas.",colors,pianoOctaves:3,grandStaff:true,
    sections:[{label:"Primeira margem",notes:["Dó4","Ré4","Mi4","Sol4"]},{label:"Ponte",notes:["Mi4","Fá4","Sol4","Lá4"]},{label:"Outra margem",notes:["Sol4","Fá4","Mi4","Ré4"]},{label:"Encontro",notes:["Dó4","Mi4","Sol4","Dó5"]}],
    sequence:["Dó4","Ré4","Mi4","Sol4","Mi4","Fá4","Sol4","Lá4","Sol4","Fá4","Mi4","Ré4","Dó4","Mi4","Sol4","Dó5"],
    scoreEvents:[
      {right:["Dó4"],left:["Dó3"],beats:1,rightFingering:[1],leftFingering:[5],dynamic:"p",articulation:"legato"},
      {right:["Ré4"],left:["Sol3"],beats:1,rightFingering:[2],leftFingering:[2],articulation:"legato"},
      {right:["Mi4"],left:["Dó3"],beats:1,rightFingering:[3],leftFingering:[5],articulation:"legato"},
      {right:["Sol4"],left:["Sol3"],beats:1,rightFingering:[5],leftFingering:[2],articulation:"accent",phraseEnd:true},
      {right:["Mi4"],left:["Dó3","Sol3"],beats:1,rightFingering:[2],leftFingering:[5,2],dynamic:"mp"},
      {right:["Fá4"],left:["Dó3","Sol3"],beats:1,rightFingering:[3],leftFingering:[5,2],articulation:"legato"},
      {right:["Sol4"],left:["Fá3"],beats:1,rightFingering:[4],leftFingering:[5],articulation:"legato"},
      {right:["Lá4"],left:["Dó4"],beats:1,rightFingering:[5],leftFingering:[1],articulation:"accent",phraseEnd:true},
      {right:["Sol4"],left:["Sol3"],beats:.5,rightFingering:[5],leftFingering:[5],dynamic:"mf",articulation:"staccato"},
      {right:["Fá4"],left:["Ré4"],beats:.5,rightFingering:[4],leftFingering:[1],articulation:"staccato"},
      {right:["Mi4"],left:["Sol3"],beats:1,rightFingering:[3],leftFingering:[5],articulation:"legato"},
      {right:["Ré4"],left:["Sol3"],beats:2,rightFingering:[2],leftFingering:[5],articulation:"legato",phraseEnd:true},
      {right:["Dó4","Mi4"],left:["Dó3","Sol3"],beats:1,rightFingering:[1,3],leftFingering:[5,2],dynamic:"mp"},
      {right:["Mi4","Sol4"],left:["Dó3","Sol3"],beats:1,rightFingering:[2,4],leftFingering:[5,2]},
      {right:["Sol4"],left:["Sol3","Ré4"],beats:1,rightFingering:[4],leftFingering:[5,1]},
      {right:["Dó5"],left:["Dó3","Sol3"],beats:2,rightFingering:[5],leftFingering:[5,2],dynamic:"p",phraseEnd:true}
    ]
  },
