...
export const repertoireScores: RepertoireScore[] = [
  ...
  {
    id: "v2-scale-c-two-octaves",
    title: "Escala de Dó · Duas Oitavas",
    subtitle: "Mão direita · continuidade de posição · original Luwipi",
    level: "Em progresso",
    kind: "study",
    hand: "right",
    clef: "treble",
    volumeReference: 2,
    skills: ["escala", "duas oitavas", "passagem do polegar"],
    source: "Estudo original do Luwipi baseado na etapa de duas oitavas mostrada no Volume 2; não reproduz a edição Suzuki.",
    methodReferences: ["Suzuki Piano School, Vol. 2 — referência à escala de Dó maior em duas oitavas"],
    notes: [
      n("Dó",60,-2,1,1,true),n("Ré",62,-1,1,2),n("Mi",64,0,1,3),n("Fá",65,1,1,1,true),
      n("Sol",67,2,1,2),n("Lá",69,3,1,3),n("Si",71,4,1,4),n("Dó",72,5,1,1,true),
      n("Ré",74,6,1,2),n("Mi",76,7,1,3),n("Fá",77,8,1,1),n("Sol",79,9,1,2,true),
      n("Lá",81,10,1,3),n("Si",83,11,1,4),n("Dó",84,12,2,5,false,true),
    ],
  },
  {
    id: "v4-even-finger-study",
    title: "Dedos Iguais · Volume 4",
    subtitle: "Figurações contínuas · original Luwipi",
    level: "Avançado",
    kind: "study",
    hand: "right",
    clef: "treble",
    volumeReference: 4,
    skills: ["agilidade", "regularidade", "passagem de dedos"],
    source: "Estudo original do Luwipi para uniformidade digital no nível técnico observado no Volume 4.",
  ...
  {
    id: "v5-romantic-study",
    title: "Frase Romântica · Volume 5",
    subtitle: "Direção, respiração e pedal · original Luwipi",
    level: "Avançado",
    kind: "study",
    hand: "both",
    clef: "grand",
    volumeReference: 5,
    skills: ["frase longa", "voicing", "pedal", "dinâmica"],
    source: "Estudo original do Luwipi para frase romântica e pedal consciente no nível do Volume 5.",
    methodReferences: ["Suzuki Piano School, Vol. 5 — referência de nível expressivo; não reproduz Chopin ou Schumann"],
    notes: [n("Lá",69,3),n("Dó",72,5),n("Mi",76,7),n("Ré",74,6),n("Dó",72,5),n("Lá",69,3,2)],
    events: [
      e([t("Lá",69,3,3)],[t("Lá",45,-3,5)],1,true,false,"p","legato","down"),
      e([t("Dó",72,5,5)],[t("Mi",52,0,2)]),
      e([t("Mi",76,7,5)],[t("Dó",48,-2,1)],1,false,true,"mp"),
      e([t("Ré",74,6,4)],[t("Fá",53,1,5)],1,true,false,"mf","legato","up"),
      e([t("Dó",72,5,3)],[t("Lá",57,3,1)],1,false,false,"p",undefined,"down"),
      e([t("Lá",69,3,1)],[t("Mi",52,0,2)],2,false,true,"pp",undefined,"up"),
    ],
  },
  {
    id: "v5-repetition-study",
    title: "Repetição Leve · Volume 5",
    subtitle: "Precisão sem endurecer · original Luwipi",
    level: "Avançado",
    kind: "study",
    hand: "right",
    clef: "treble",
    volumeReference: 5,
    skills: ["repetição", "troca de dedos", "articulação"],
    source: "Estudo original do Luwipi para repetição rápida e controlo de ataque no nível do Volume 5.",
    methodReferences: ["Suzuki Piano School, Vol. 5 — referência de nível técnico; não reproduz The Cuckoo"],
    notes: [
      n("Mi",64,0,1,3,true),n("Mi",64,0,1,2),n("Mi",64,0,1,1),n("Sol",67,2,1,4,true),
      n("Sol",67,2,1,3),n("Sol",67,2,1,2),n("Fá",65,1,1,3),n("Ré",62,-1,1,1,true,true),
      n("Fá",65,1,1,4,true),n("Fá",65,1,1,3),n("Fá",65,1,1,2),n("Lá",69,3,1,5,true),
      n("Sol",67,2,1,4),n("Mi",64,0,1,3),n("Ré",62,-1,1,2),n("Dó",60,-2,2,1,false,true),
    ],
  },
