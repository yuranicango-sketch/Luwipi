    ...
    <main className="auth-page">
      ...
      <div className="container auth-grid">
        ...
        <section className="auth-card">
          <div className="eyebrow">3 dias para experimentar</div>
          <h1>Entrar na Luwipi</h1>
          <p>Experimente o primeiro módulo durante 3 dias. Depois, continue com uma subscrição.</p>
          <GoogleLoginButton />
          ...
          <div className="trust-row"><span>♥ Seguro para crianças</span><span>⚡ Acesso imediato</span><span>★ Pagamento seguro com Paddle</span></div>
        </section>
      </div>
    </main>
  );
